...
class BumpCollision {
  addCollisionProperties(sprite) {
    ...
    if (sprite.gx === undefined) {
      Object.defineProperty(sprite, "gx", {
        get: () => sprite.getGlobalPosition().x,
        enumerable: true,
        configurable: true
      });
    }
    ...
    if (sprite.gy === undefined) {
      Object.defineProperty(sprite, "gy", {
        get: () => sprite.getGlobalPosition().y,
        enumerable: true,
        configurable: true
      });
    }
    ...
    if (sprite.xAnchorOffset === undefined) {
      Object.defineProperty(sprite, "xAnchorOffset", {
        get: () => sprite.anchor !== undefined ? sprite.width * sprite.anchor.x : 0,
        enumerable: true,
        configurable: true
      });
    }
    ...
    if (sprite.yAnchorOffset === undefined) {
      Object.defineProperty(sprite, "yAnchorOffset", {
        get: () => sprite.anchor !== undefined ? sprite.height * sprite.anchor.y : 0,
        enumerable: true,
        configurable: true
      });
    }
  ...
  rectangleCollision(r1, r2, bounce, global) {
  ...
  circleRectangleCollision(c1, r1, bounce, global) {
    //Add collision properties
    if (!r1._bumpPropertiesAdded) this.addCollisionProperties(r1);
    if (!c1._bumpPropertiesAdded) this.addCollisionProperties(c1);
  ...
  contain(sprite, container, bounce, extra) {
  ...
  hitTest(displayObject, displayObjects) {
    let hitDirections = {
      top: false,
      left: false,
      bottom: false,
  ...
  hitTestLeft(displayObject, displayObjects) {
    for (let i = displayObjects.length - 1; i >= 0; i--) {
      let displayObject2 = displayObjects[i];
      if (
...
export default new BumpCollision();
